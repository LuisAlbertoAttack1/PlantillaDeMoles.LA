        ...
        <div class="row">
            <div class="col">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-6">
                    <div class="col">
                        <div class="card colorTransparenteCards rounded border-0" data-aos="zoom-in"
                            data-aos-duration="4000">
                            <div class="card-img">
                                <img src="../img/ImgVasos.png"
                            ...
                            <div class="card-body text-center tipo-letra">
                                ...
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <a href="../views-Recetas/Views-Receta-6.php"
                                        class="btn mt-2 mb-2 fondo-color-indefinido-center rounded-pill">Ver
                                        Receta</a>
                                    <!--R1-->
                                </div>
                            </div>
