...
<head>
    ...
    <title>Views-vistasRecetas.php!</title>
</head>
...
<body class="fondoRecetasVistas">
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <h2 class="text-center">Hola ya estas dentro de la seccion de recetas</h2>
                <br>
                        ...
                        <div class="card colorTransparenteCards rounded border-0">
                            ...
                            <div class="card-body text-center tipo-letra">
                                ...
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <a href="../views-Recetas/Views-Receta-6.php"
                                        class="btn mt-2 mb-2 fondo-color-indefinido-center" type="button">Ver
                                        Receta</a>
                                    <!--R1-->
                                </div>
                            </div>
                        ...
                        <div class="card  colorTransparenteCards rounded border-0">
                            ...
                            <div class="card-body text-center tipo-letra">
                                ...
                                <h6 class="text-white">El mole es uno de los platillos más
                                    ...
                                    mexicana.</h6>
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <a href="../views-Recetas/Views-Receta-7.php"
                                        class="btn mt-2 mb-2 fondo-color-indefinido-center" type="button">Ver
                                        Receta</a>
                                    <!--R2-->
                                </div>
                        ...
                        <div class="card  colorTransparenteCards rounded border-0">
                            ...
                            <div class="card-body text-center tipo-letra">
                                ...
                                <h6 class="text-white">El mole es uno de los platillos más
                                    ...
                                    mexicana.</h6>
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <a href="../views-Recetas/Views-Receta-8.php"
                                        class="btn mt-2 mb-2 fondo-color-indefinido-center" type="button">Ver
                                        Receta</a>
                                    <!--R3-->
                                </div>
                        ...
                        <div class="card colorTransparenteCards rounded border-0">
                            ...
                            <div class="card-body text-center tipo-letra">
                                ...
                                <h6 class="text-white">El mole es uno de los platillos más
                                    ...
                                    mexicana.</h6>
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <a href="./views-Recetas/Views-Receta-1.php"
                                        class="btn mt-2 mb-2 fondo-color-indefinido-center" type="button">Ver
                                        Receta</a>
                                    <!--R1-->
                                </div>
                        ...
                        <div class="card  colorTransparenteCards rounded border-0">
                            ...
                            <div class="card-body text-center tipo-letra">
                                ...
                                <h6 class="text-white">El mole es uno de los platillos más
                                    ...
                                    mexicana.</h6>
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <a href="./views-Recetas/Views-Receta-2.php"
                                        class="btn mt-2 mb-2 fondo-color-indefinido-center" type="button">Ver
                                        Receta</a>
                                    <!--R2-->
                                </div>
                        ...
                        <div class="card  colorTransparenteCards rounded border-0">
                            ...
                            <div class="card-body text-center tipo-letra">
                                ...
                                <h6 class="text-white">El mole es uno de los platillos más
                                    ...
                                    mexicana.</h6>
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <a href="./views-Recetas/Views-Receta-3.php"
                                        class="btn mt-2 mb-2 fondo-color-indefinido-center" type="button">Ver
                                        Receta</a>
                                    <!--R3-->
                                </div>
